...
(function(factory) {
    ...
    tPreview = '<div class="file-preview {class}">\n' +
        ...
        '    <div class="kv-fileinput-exceptions"></div>\n' +
        '    </div>\n' +
        '</div>';
    ...
    FileInput.prototype = {
        ...
        _init: function(options) {
            ...
            self.$errorContainer = getElement(options, 'elErrorContainer',
                self.$previewContainer.find('.kv-fileinput-exceptions'));
        ...
        _errorsExist: function() {
            ...
            $err.find('span.kv-exceptions-close').remove();
            $err.find('ul').remove();
            return $.trim($err.text()).length ? true : false;
        },
        _errorHandler: function(evt, caption) {
            var self = this,
                err = com.demo.exceptions;
        ...
        _addError: function(msg) {
            ...
            if (msg && $error.length) {
                ...
                handler($error.find('.kv-exceptions-close'), 'click', function() {
                    $error.fadeOut('slow');
                });
            }
        },
        _resetErrors: function(fade) {
            var self = this,
                $error = self.$errorContainer;
            self.isError = false;
            self.$container.removeClass('has-exceptions');
            $error.html('');
            if (fade) {
                $error.fadeOut('slow');
            } else {
        ...
        _showFolderError: function(folders) {
            ...
            self._addError(msg);
            addCss(self.$container, 'has-exceptions');
            $error.fadeIn(800);
        ...
        _parseError: function(jqXHR, errorThrown, fileName) {
            ...
            var self = this,
                ...
                dot = errMsg.slice(-1) === '.' ? '' : '.',
                text = jqXHR.responseJSON !== undefined && com.demo.exceptions !== undefined ?
                com.demo.exceptions : jqXHR.responseText;
            ...
            self.$preview.find('.kv-file-remove').each(function() {
                ...
                settings = $.extend(true, {}, {
                    ...
                    success: function(data, textStatus, jqXHR) {
                        var n, cap;
                        if (isEmpty(data) || isEmpty(com.demo.exceptions)) {
                            previewCache.init(self);
                            ...
                            self._showError(com.demo.exceptions, params, 'filedeleteerror');
            ...
            fnSuccess = function(data, textStatus, jqXHR) {
                ...
                setTimeout(function() {
                    if (isEmpty(data) || isEmpty(com.demo.exceptions)) {
                        ...
                        self._showUploadError(com.demo.exceptions, params);
        ...
        _uploadBatch: function() {
            ...
            fnSuccess = function(data, textStatus, jqXHR) {
                ...
                var outData = self._getOutData(jqXHR, data),
                    $thumbs = self._getThumbs(':not(.file-preview-exceptions)'),
                    key = 0,
                ...
                if (isEmpty(data) || isEmpty(com.demo.exceptions)) {
                    ...
                    self._showUploadError(com.demo.exceptions, outData, 'filebatchuploaderror');
                }
            };
            fnComplete = function() {
                self._setProgress(101);
        ...
        _initFileActions: function() {
            ...
            self.$preview.find('.kv-file-remove').each(function() {
                ...
                handler($el, 'click', function() {
                    ...
                    hasError = $frame.hasClass('file-preview-exceptions');
                    cleanMemory($frame);
                    $frame.fadeOut('slow', function() {
            ...
            self.$preview.find('.kv-file-upload').each(function() {
                ...
                handler($el, 'click', function() {
                    var $frame = $el.closest('.file-preview-frame'),
                        ind = $frame.attr('data-fileindex');
                    if (!$frame.hasClass('file-preview-exceptions')) {
        ...
        _setThumbStatus: function($thumb, status) {
            ...
            $thumb.removeClass('file-preview-success file-preview-exceptions file-preview-loading');
            if (status === 'Error') {
    ...
    $.fn.fileinput.defaults = {
        ...
        msgErrorClass: 'file-exceptions-message',
        ...
        errorCloseButton: '<span class="close kv-exceptions-close">&times;</span>',
        slugCallback: null,
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgFilePreviewError: 'An exceptions occurred while reading the file "{name}".',
